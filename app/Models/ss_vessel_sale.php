...
class ss_vessel_sale extends Model
{
    ...
    public function vesseltype(){
        return $this->hasMany('App\Models\rel_vsale_vesseltype',"vessel_sale_id");
    }
    public function region(){
        return $this->hasMany('App\Models\rel_vsale_region',"vessel_sale_id");
    }
    public function country(){
        return $this->hasMany('App\Models\rel_vsale_country',"vessel_sale_id");
    }
    public function port(){
        return $this->hasMany('App\Models\rel_vsale_port',"vessel_sale_id");
    }
