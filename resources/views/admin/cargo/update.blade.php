    ...
    <div class="row">
        <div class="col-md-12 ">
            <div class="x_panel">
                <div class="x_content">
                    <br />
                    <form method="post" action="/admin/cargo/update_req" class="form-horizontal form-label-left"
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <select name="cargo_type_id" required class="form-control">
                                ...
                                <option value="{{$row->cargo_type_id}}" {{ $res->cargo_type_id==$row->cargo_type_id ? 'selected' : '' }}>
                                    {{$row->cargo_type_name}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <select name="loading_region_id" id="loading_region_id" required class="form-control">
                                ...
                                <option value="{{$row->region_id}}" {{ $res->loading_region_id==$row->region_id ? 'selected' : '' }}>
                                {{$row->region_name}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-sm-4 mt-4">
                            ...
                            <select name="loading_country_id" id="loading_country_id" required class="form-control">
                                ...
                                <option value="{{$row->country_id}}" {{ $res->loading_country_id==$row->country_id ? 'selected' : '' }}>
                                {{$row->country_name}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-sm-4 mt-4">
                            ...
                            <select name="loading_port_id_1" id="loading_port_id_1" required class="form-control">
                                <option value="-1" disabled selected>Choose</option>
                                @foreach ($port as $row)
                                <option value="{{$row->port_id}}" {{ $res->loading_port_id_1==$row->port_id ? 'selected' : '' }}>
                                {{$row->port_name}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-sm-4 mt-4">
                            ...
                            <select name="loading_port_id_2" id="loading_port_id_2" required class="form-control">
                                <option value="-1" disabled selected>Choose</option>
                                @foreach ($port as $row)
                                <option value="{{$row->port_id}}" {{ $res->loading_port_id_2==$row->port_id ? 'selected' : '' }}>
                                {{$row->port_name}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-sm-4 mt-4">
                            ...
                            <select name="discharge_region_id" id="discharge_region_id" required class="form-control">
                                <option value="-1" disabled selected>Choose</option>
                                @foreach ($region as $row)
                                <option value="{{$row->region_id}}" {{ $res->discharge_region_id==$row->region_id ? 'selected' : '' }}>
                                {{$row->region_name}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-sm-4 mt-4">
                            ...
                            <select name="discharge_country_id" id="discharge_country_id" required class="form-control">
                                <option value="-1" disabled selected>Choose</option>
                                @foreach ($country as $row)
                                <option value="{{$row->country_id}}" {{ $res->discharge_country_id==$row->country_id ? 'selected' : '' }}>
                                {{$row->country_name}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-sm-4 mt-4">
                            ...
                            <select name="discharge_port_id_1" id="discharge_port_id_1" required class="form-control">
                                <option value="-1" disabled selected>Choose</option>
                                @foreach ($port as $row)
                                <option value="{{$row->port_id}}" {{ $res->discharge_port_id_1==$row->port_id ? 'selected' : '' }}>
                                {{$row->port_name}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-sm-4 mt-4">
                            ...
                            <select name="discharge_port_id_2" id="discharge_port_id_2" required class="form-control">
                                <option value="-1" disabled selected>Choose</option>
                                @foreach ($port as $row)
                                <option value="{{$row->port_id}}" {{ $res->discharge_port_id_2==$row->port_id ? 'selected' : '' }}>
                                {{$row->port_name}}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-sm-4 mt-4">
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" value="{{$res->quantity}}" required name="quantity" class="form-control">
                            </div>
                            <!-- -->
                            <div class="form-group col-sm-6">
                                ...
                                <select name="unit_id" required class="form-control">
                                    <option value="-1" disabled selected>Choose</option>
                                    @foreach ($unit as $row)
                                    <option value="{{$row->unit_id}}" {{ $res->unit_id==$row->unit_id ? 'selected' : '' }}>
                                    {{$row->unit_name}}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group col-sm-4 mt-4">
                            ...
                            <input type="text" value="{{$res->max_draft}}" required name="max_draft" class="form-control">
                        </div>
                        <!-- -->
                        <div class="form-group col-sm-4 mt-4">
                            <label for="">Max Height</label>
                            <input type="text" value="{{$res->max_height}}" required name="max_height" class="form-control">
                        </div>
                        <!-- -->
                        <div class="form-group col-sm-4 mt-4">
                            <label for="">Commission</label>
                            <input type="text" value="{{$res->commision}}" required name="commision" class="form-control">
                        </div>
                        <!-- -->
                        ...
                        <div class="form-group col-sm-4 mt-4">
                            ...
                            <div class="form-check-inline">
                                <input class="form-check-input" type="radio" id="hazmat1" name="hazmat" value="Yes" {{ $res->hazmat=="Yes" ? 'checked' : '' }}  />
                                <label class="form-check-label " for="hazmat1"> Yes </label>
                            </div>
                            <div class="form-check-inline">
                                <input class="form-check-input" type="radio" id="hazmat2" name="hazmat" value="No" {{ $res->hazmat=="No" ? 'checked' : '' }} />
                        ...
                        <div class="col-sm-4 mt-4">
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" value="{{$res->loading_discharge_rates}}" required name="loading_discharge_rates" class="form-control">
                            </div>
                            <!-- -->
                            <div class="form-group col-sm-6">
                                ...
                                <select name="loading_discharge_unit_id" required class="form-control">
                                    <option value="-1" disabled selected>Choose</option>
                                    @foreach ($unit as $row)
                                    <option value="{{$row->unit_id}}" {{ $res->loading_discharge_unit_id==$row->unit_id ? 'selected' : '' }}>
                        ...
                        <div class="form-group col-sm-4 mt-4">
                            ...
                            <input type="text" value="{{$res->loading_equipment_req}}" required name="loading_equipment_req" class="form-control">
                        </div>
                        <!-- -->
                        <div class="form-group col-sm-4 mt-4">
                            <label for="">Gear Lifting Capacity</label>
                            <input type="text" value="{{$res->gear_lifting_capacity}}" required name="gear_lifting_capacity" class="form-control">
                        </div>
                        <!-- -->
                        <div class="col-sm-4 mt-4">
                            <label for="">Gear Lifting Capacity</label>
                            <div class="form-row pl-4  border">
                                <div class="form-group col-sm-6">
                                    ...
                                    <div class="mt-2">
                                        <input class="form-check-input" type="checkbox"
                                            name="loading_discharge_equipment_req[]" value="Pipes/Hoses">Pipes/Hoses
                                    </div>
                                    <div class="mt-2">
                                        <input class="form-check-input" type="checkbox"
                                            name="loading_discharge_equipment_req[]" value="Dunnage">Dunnage
                                    </div>
                                    <div class="mt-2">
                                        <input class="form-check-input" type="checkbox"
                                            name="loading_discharge_equipment_req[]" value="Other"
                                            @foreach($eq_req as $row) @if($row == " Other") checked @endif @endforeach 
                                            >Other
                                    </div>
                                </div>
                                <div class="form-group col-sm-6">
                                    <div class="mt-2">
                                        <input class="form-check-input" type="checkbox"
                                            name="loading_discharge_equipment_req[]" value="Conveyor Belt">Conveyor Belt
                                    </div>
                                    <div class="mt-2">
                                        <input class="form-check-input" type="checkbox"
                                            name="loading_discharge_equipment_req[]" value="Pallets">Pallets
                                    </div>
                                    <div class="mt-2">
                                        <input class="form-check-input" type="checkbox"
                                            name="loading_discharge_equipment_req[]" value="Pontoon Cover">Pontoon Cover
                                    </div>
                                </div>
                            </div>
